...
void GCodePlanner::addPolygonsByOptimizer(Polygons& polygons, GCodePathConfig* config, WallOverlapComputationSettings* wall_overlap_computation_settings, EZSeamType z_seam_type, bool spiralize)
{
    if (polygons.size() == 0)
    {
        return;
